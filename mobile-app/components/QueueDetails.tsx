    ...
    <View className="items-center justify-center w-11/12 mt-8 bg-white rounded-2xl h-1/2">
      {branch == -1 ?
        <>
          ...
          <Text className="text-center text-[#444444] mt-3.5">
        ...
        !leave ?
          <>
            <View className="items-center">
              ...
              <View className="flex-row items-center mt-1">
                ...
                <Text className="text-base text-[#444444] ">
                  ~18 min
                </Text>
              </View>
            </View>
          ...
          <>
            <View className="items-center">
            ...
            </View><View className="items-center w-full mt-8">
              <View className="flex-row items-center justify-center w-[60%]  relative h-9 mb-2">
                ...
                <View className="bg-[#D9D9D9] w-full rounded-full h-[80%] flex justify-center items-center">
                  <Text className="text-[#1DCDFE] text-base text-center">
                    Queue Joined!
                  </Text>
                </View>
              </View>
              <TouchableOpacity
                className="bg-[#B41818] px-6 py-1 rounded-lg justify-center items-center"
