...
export default function AddPartnerModal({ 
  ...
  const [step, setStep] = useState<'verify' | 'new_partner' | 'add_location'>('verify');
        ...
        <>
          ...
          >
            <h2 className={`text-xl font-bold mb-4 ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>
              {matchedPartner ? `Add Location to ${matchedPartner.name}` : 'Add New Partner'}
            </h2>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                {formData.locations.map((location, index) => (
                  <div key={index} className="space-y-4 p-4 rounded-lg border border-dashed border-crystal-blue/30">
                    <div className="flex justify-between items-center">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => handleLocationChange(index, 'stateOrProvince', e.target.value)}
