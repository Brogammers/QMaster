            ...
            <div className="flex-1 flex flex-col h-screen overflow-auto">
                <div className="flex-1 flex flex-col px-8 py-4 relative">
                    ...
                    <div className="w-full text-center text-white/80 py-4 text-xs">
                        Join millions of customers managing their queues and
                        discovering stores all in one place
                    </div>
                </div>
            </div>
                ...
                <div className="w-full max-w-sm mx-auto mt-16">
                    <div className="rounded-lg bg-white p-6 shadow-sm">
                        ...
                        <h3 className="text-xl font-semibold mb-2 text-[#1F2937]">
                            Trusted by top workers and leading businesses in the
                            Light Industrial space
                        </h3>
                        <p className="text-gray-600 mb-4">
                            &ldquo;QMaster has been a true partner to us. Their
                            worker quality has been a differentiator for us. I
                            do really think this is the future.&rdquo;
                        </p>
