...
const QueueForm = ({ closeModal, onAddQueue, initialValues }: any) => {
  ...
  const handleSubmit = (values: any) => {
    const newQueueItem = [
      values.queueName,
      values.limitQueueLength,
      values.visitorsToNotify,
      values.estimatedWaitingTimeMode,
      values.enabledOnlyInOpeningHours
    ];
